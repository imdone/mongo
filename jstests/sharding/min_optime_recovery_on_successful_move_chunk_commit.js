...
(function() {
    ...
    assert.eq(st.configRS.getURL(),
              minOpTimeRecoveryDoc.configsvrConnectionString);       // TODO SERVER-34166: Remove. id:251
    assert.eq(st.shard0.shardName, minOpTimeRecoveryDoc.shardName);  // TODO SERVER-34166: Remove. id:894

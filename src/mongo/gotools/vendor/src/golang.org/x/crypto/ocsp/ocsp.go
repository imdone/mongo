...
// TODO (rlb): This is also from crypto/x509, so same comment as AGL's below id:2167
...
// TODO (rlb): This is also from crypto/x509, so same comment as AGL's below id:1073
...
// TODO (agl): this is taken from crypto/x509 and so should probably be exported id:882
...
// TODO (rlb): This is not taken from crypto/x509, but it's of the same general form. id:1693

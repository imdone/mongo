...
// TODO: consider supporting BYS (-> BLR), CSK (-> 200 or CZ), PHI (-> PHL) and AFI (-> DJ). id:3028
// TODO: consider mapping split up regions to new most populous one (like CLDR). id:1270

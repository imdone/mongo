...
void RBBITableBuilder::calcChainedFollowPos(RBBINode *tree) {
    ...
    for (endNodeIx=0; endNodeIx<leafNodes.size(); endNodeIx++) {
        ...
        //                            don't chain from it.
        // TODO: Add rule syntax for this behavior, get specifics out of here and id:1918
        //        into the rule file.
        if (fRB->fLBCMNoChain) {
        ...
        for (n=0; n<fDStates->size(); n++) {
            ...
            if (sd->fPositions->indexOf(endMarker) >= 0) {
                ...
                if (sd->fAccepting==-1 && endMarker->fVal != 0) {
                    ...
                    // TODO: need a more elegant resolution for conflicting rules. id:3228
                    sd->fAccepting = endMarker->fVal;
                }
                // implicit else:
                ...
                if (endMarker->fLookAheadEnd) {
                    // TODO: don't change value if already set? id:2785
                    // TODO: allow for more than one active look-ahead rule in engine. id:1639

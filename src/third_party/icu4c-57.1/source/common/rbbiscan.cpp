...
//
//                       TODO: unify EParseAction and RBBI_RuleParseAction enum types. id:1916
...
UBool RBBIRuleScanner::doParseActions(int32_t action)
{
    ...
    case doEndOfRule:
        ...
        if (fLookAheadRule) {
            ...
            // TODO: Disable chaining out of look-ahead (hard break) rules. id:3227
...
void RBBIRuleScanner::scanSet() {
    ...
    if (U_FAILURE(localStatus)) {
        //  TODO: Get more accurate position of the error from UnicodeSet's return info. id:2783

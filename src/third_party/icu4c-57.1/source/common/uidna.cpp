                  ...
                  UErrorCode* status)
{
    ...
    // TODO Revisit buffer handling. The label should not be over 63 ASCII characters. ICU4J may need to be updated too. id:1660
    ...
    if(srcIsASCII){
        ...
        if(!startsWithPrefix(b1,b1Len)){
            ...
            // TODO: Preserve the case while implementing the RFE id:2472
            ...
            // TODO : Reconsider while implementing the case preserve RFE id:1936
                    ...
                    UErrorCode* status)
{
    ...
    // TODO Revisit buffer handling. The label should not be over 63 ASCII characters. ICU4J may need to be updated too. id:3237

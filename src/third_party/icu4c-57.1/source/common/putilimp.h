 ...
 */
/* TODO: This check fails on some z environments. Filed a ticket #9357 for this. id:2411*/
 ...
 */
    ...
    /* TODO: Intel icc and IBM xlc on AIX also support gcc atomics. (Intel originated them.) id:1902

 ...
 * NOTE: The string "root" is not recognized; do not use it. id:1653
...
// TODO: a better way to define this? id:2467
    ...
    *total_currency_symbol_count = 0;
    ...
    for (int32_t localeLevel = 0; ; ++localeLevel) {
        ...
        for (int32_t i=0; i<n; ++i) {
            ...
            int32_t len;
            s = ures_getStringByIndex(names, UCURR_SYMBOL_NAME, &len, &ec2);
            // TODO: uhash_put wont change key/value? id:2799
        ...
        for (int32_t i=0; i<n; ++i) {
            ...
            for (int32_t j = 0; j < num; ++j) {
                // TODO: remove duplicates between singular name and id:1656
                // currency long name?

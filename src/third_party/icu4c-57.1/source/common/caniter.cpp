...
// TODO: add boilerplate methods. id:1612
...
/**
 *@return gets the source: NOTE: it is the NFD form of source id:2399
 */
...
UnicodeString* CanonicalIterator::getEquivalents(const UnicodeString &segment, int32_t &result_len, UErrorCode &status) {
    ...
    // TODO: optimize by not permuting any class zero. id:3216
    ...
    while (ne != NULL) {
        ...
        while (ne2 != NULL) {
            ...
            // TODO: check if operator == is semanticaly the same as attempt.equals(segment) id:2761
            if (attempt==segment) {
                //if (PROGRESS) printf("Adding Permutation: %s\n", UToS(Tr(*possible)));
                // TODO: use the hashtable just to catch duplicates - store strings directly (somehow). id:1614

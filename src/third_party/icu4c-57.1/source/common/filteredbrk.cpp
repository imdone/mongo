...
SimpleFilteredSentenceBreakIterator::breakExceptionAt(int32_t n) {
    ...
    if((uch=utext_previous32(fText.getAlias()))==(UChar32)0x0020) {  // TODO: skip a class of chars here?? id:2765
      // TODO only do this the 1st time? id:1619
...
SimpleFilteredBreakIteratorBuilder::build(BreakIterator* adoptBreakIterator, UErrorCode& status) {
  ...
  for(int i=0;i<subCount;i++) {
    int nn = ustrs[i].indexOf(kFULLSTOP); // TODO: non-'.' abbreviations id:2405

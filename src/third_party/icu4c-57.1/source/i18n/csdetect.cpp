...
charsetMatchComparator(const void * /*context*/, const void *left, const void *right)
{
    ...
    // NOTE: compare is backwards to sort from highest to lowest. id:2871
...
{
    if(!textIn->isSet()) {
        status = U_MISSING_RESOURCE_ERROR;// TODO: Need to set proper status code for input text not set id:1758

...
PluralRules::internalForLocale(const Locale& locale, UPluralType type, UErrorCode& status) {
    ...
    // TODO: which errors, if any, should be returned? id:3278
    if (locRule.length() == 0) {
    ...
    parser.parse(locRule, newObj, status);
        //  TODO: should rule parse errors be returned, or id:2888
...
getSamplesFromString(const UnicodeString &samples, double *dest,
    ...
    //std::string ss;  // TODO: debugging. id:1799
...
PluralRuleParser::parse(const UnicodeString& ruleData, PluralRules *prules, UErrorCode &status)
{
    ...
    while (ruleIndex< ruleSrc->length()) {
        ...
        case tNumber:
            ...
            break;
        case tComma:
            // TODO: rule syntax checking is inadequate, can happen with badly formed rules. id:2553
...
PluralRuleParser::checkSyntax(UErrorCode &status)
{
    ...
    case tNumber:
        ...
        // TODO: a comma following a number that is not part of a range will be allowed. id:2050
...
FixedDecimal::FixedDecimal(double n, int32_t v, int64_t f) {
    init(n, v, f);
    // check values. TODO make into unit test. id:3279
    //            
...
//    TODO: need to think through how this is used in the plural rule context. id:2889

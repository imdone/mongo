...
{
    return *addr;               // FIXME (1208663): not yet safe id:2354
}
...
{
    *addr = val;                // FIXME (1208663): not yet safe id:3345
}

inline void
js::jit::AtomicOperations::memcpySafeWhenRacy(void* dest, const void* src, size_t nbytes)
{
    ::memcpy(dest, src, nbytes); // FIXME (1208663): not yet safe id:2978
}

inline void
js::jit::AtomicOperations::memmoveSafeWhenRacy(void* dest, const void* src, size_t nbytes)
{
    ::memmove(dest, src, nbytes); // FIXME (1208663): not yet safe id:2078
}

...
{
    return *addr; // FIXME (1208663): not yet safe id:2653
}
...
{
    *addr = val; // FIXME (1208663): not yet safe id:2306
}
...
js::jit::AtomicOperations::memcpySafeWhenRacy(void* dest, const void* src,
                                              size_t nbytes)
{
    memcpy(dest, src, nbytes); // FIXME (1208663): not yet safe id:3328
}
...
js::jit::AtomicOperations::memmoveSafeWhenRacy(void* dest, const void* src,
                                               size_t nbytes)
{
    memmove(dest, src, nbytes); // FIXME (1208663): not yet safe id:2947
}
